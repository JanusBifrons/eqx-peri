...
export const STRUCTURE_DEFINITIONS: Readonly<Record<StructureType, StructureDefinition>> = {
  ...
  SolarPanel: {
    ...
    parts: [
      ...
      // Left solar panel array
      {
        ...
        zOrder: 0,
        details: [
          // Cell grid — 3 vertical dividers (4 columns)
          { type: 'line', x1: -16, y1: -34, x2: -16, y2: 34, color: '#5588bb', alpha: 0.5, lineWidth: 1 },
          { type: 'line', x1:   0, y1: -34, x2:   0, y2: 34, color: '#5588bb', alpha: 0.5, lineWidth: 1 },
          { type: 'line', x1:  16, y1: -34, x2:  16, y2: 34, color: '#5588bb', alpha: 0.5, lineWidth: 1 },
          // Horizontal midline
          { type: 'line', x1: -46, y1: 0, x2: 46, y2: 0, color: '#5588bb', alpha: 0.4, lineWidth: 1 },
        ],
      },
      ...
      // Central support hub (drawn on top)
      {
        partId: 'hub',
        shape: 'hex',
        widthPx: 52,
        ...
        zOrder: 1,
        details: [
          { type: 'circle', cx: 0, cy: 0, radius: 10, color: '#4488ff', fill: true, alpha: 0.6 },
          { type: 'circle', cx: 0, cy: 0, radius: 18, color: '#5599dd', fill: false, lineWidth: 1 },
        ],
      },
    ],
  },
  ...
  PowerStation: {
    ...
    borderColor: '#6644cc',
    parts: [
      // North radiator fin (drawn behind core)
      {
        partId: 'fin-north',
        shape: 'rect',
        widthPx: 28,
        ...
        zOrder: 0,
        details: [
          // Heat dissipation fins — horizontal lines spanning the width
          { type: 'line', x1: -12, y1: -30, x2: 12, y2: -30, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
          { type: 'line', x1: -12, y1: -10, x2: 12, y2: -10, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
          { type: 'line', x1: -12, y1:  10, x2: 12, y2:  10, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
          { type: 'line', x1: -12, y1:  30, x2: 12, y2:  30, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
        ],
      },
      ...
      // East radiator fin
      {
        ...
        zOrder: 0,
        details: [
          // Heat fins — vertical lines spanning the height
          { type: 'line', x1: -30, y1: -12, x2: -30, y2: 12, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
          { type: 'line', x1: -10, y1: -12, x2: -10, y2: 12, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
          { type: 'line', x1:  10, y1: -12, x2:  10, y2: 12, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
          { type: 'line', x1:  30, y1: -12, x2:  30, y2: 12, color: '#9966cc', alpha: 0.7, lineWidth: 1 },
        ],
      },
      ...
      // Central reactor core (on top)
      {
        ...
        zOrder: 1,
        details: [
          // Plasma containment glow
          { type: 'circle', cx: 0, cy: 0, radius: 30, color: '#9966ff', fill: true, alpha: 0.55 },
          // Containment rings
          { type: 'circle', cx: 0, cy: 0, radius: 48, color: '#6644cc', fill: false, lineWidth: 2 },
          { type: 'circle', cx: 0, cy: 0, radius: 56, color: '#4433aa', fill: false, lineWidth: 1, alpha: 0.5 },
        ],
      },
    ],
  },
  ...
  Refinery: {
    ...
    parts: [
      // Ore input hopper (top, drawn behind core)
      {
        partId: 'hopper',
        shape: 'rect',
        widthPx: 62,
        ...
        details: [
          // Ore layer lines
          { type: 'line', x1: -24, y1: -8, x2: 24, y2: -8, color: '#cc8833', alpha: 0.6, lineWidth: 1 },
          { type: 'line', x1: -24, y1:  6, x2: 24, y2:  6, color: '#cc8833', alpha: 0.6, lineWidth: 1 },
        ],
      },
      // Pipe: hopper → core
      {
      ...
      // Left ore storage tank
      {
        ...
        zOrder: 0,
        details: [
          { type: 'circle', cx: 0, cy: 0, radius: 22, color: '#33aa55', fill: false, lineWidth: 1.5, alpha: 0.6 },
          { type: 'circle', cx: 0, cy: 0, radius: 8,  color: '#22aa44', fill: true },
        ],
      },
      // Pipe: left tank → core
      {
      ...
      // Refined material output (bottom)
      {
        partId: 'output',
        shape: 'circle',
        widthPx: 50,
        ...
        zOrder: 0,
        details: [
          { type: 'circle', cx: 0, cy: 0, radius: 12, color: '#44cc44', fill: true, alpha: 0.5 },
        ],
      },
      // Pipe: core → output
      {
      ...
      // Central processing core (on top)
      {
        partId: 'core',
        shape: 'rect',
        widthPx: 90,
        ...
        zOrder: 1,
        details: [
          { type: 'circle', cx: 0, cy: 0, radius: 22, color: '#55ee55', fill: true, alpha: 0.3 },
          { type: 'circle', cx: 0, cy: 0, radius: 35, color: '#44cc44', fill: false, lineWidth: 1.5 },
        ],
      },
    ],
  },
