...
- Renderer priorities: GridRenderer(10) → BlockBodyRenderer(20) → ParticleRenderer(22) → BlockFrillsRenderer(30) → ShieldRenderer(40) → BeamRenderer(45) → ShockwaveRenderer(46) → ShipHighlightRenderer(50) → AimingDebugRenderer(60) → BlockPickupRenderer(70).
